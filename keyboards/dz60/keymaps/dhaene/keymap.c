...
// Custom layout for the DZ60 with the SA Honeywell Keycap set
#define _DEFAULT 0
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    *   |   CTRL  |  UP  |  MENU  |             SPACE             | DOWN | SUPER| LEFT | RIGHT | DOWN |
    *   -----------------------------------------------------------------------------------------------
    */
    [_DEFAULT] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RALT, KC_LEFT, KC_LEFT, KC_RIGHT, KC_DOWN
    ),
